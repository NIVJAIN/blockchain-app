// sendGridAPIKEy: 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
...
var blobSvc = azure.createBlobService('ngpblockchain', 'oRvh4d3sM4epS+2j5JwInsaCQYzSpc/9DlBSlxVJzzQq0pij5kv3UD99Ca7X1ik++PC+NkY5/DZw//S6YfWA8g==');
...
//Start-SendDataToMongoDB
    function SendDataIntoMongoDBLocal(comNam, comAdd, comPrj, txHas, blocknumbe, blockhas) {
        mongoose.connect('mongodb://localhost/blockchaindb', function (err) {
            if (err) throw err;
...
function SendGridEmail(stringfilename, finalValue, companynameemail) {
    ...
    var sg = require('sendgrid')('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');
...
function registerCompany (information) {
  ...
  Register.deployed().then(function(instance) {
    ...
    //   }
    // });
    SendDataIntoMongoDBLocal(information[0], information[1], information[2], result.tx, result.receipt.blockNumber, result.receipt.blockHash, result.receipt.gasUsed)
  }).catch(function(err) {
